...
import com.clean.adm.catalog.domain.validation.handler.ThrowsValidationHandler;
...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        final String expectedName = """
            No entanto, não podemos esquecer que o entendimento das metas propostas garante a contribuição de um grupo importante na determinação do impacto na agilidade decisória.
            É importante questionar o quanto a contínua expansão de nossa atividade possibilita uma melhor visão global do orçamento setorial. Do mesmo modo
        """;
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedDescription = "A categoria mais assistida";
